...
DMCANMsg DMMotor::locomotion(uint8_t motor_id, float torque, float MechPosition,
  ...
  pos_tmp = float_to_uint(MechPosition, DM_P_MIN, DM_P_MAX, 16);
  vel_tmp = float_to_uint(speed, DM_V_MIN, DM_V_MAX, 12);
